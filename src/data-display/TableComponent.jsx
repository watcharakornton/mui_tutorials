...
export const AccessibleTable = () => {
    ...
    return (
        <MyContainer title="Accessible Table">
...
export const ReactVirtualizedTable = () => {
    ...
    return (
        <MyContainer title="React Virtualized Table">
...
export const SpanningTable = () => {
    ...
    return (
        <MyContainer title="Spanning Table">
            <TableContainer component={Paper} sx={{ width: '95%' }}>
...
export const CollapsibleTable = () => {
    ...
    return (
        <MyContainer title="Collabsible Table">
            <TableContainer component={Paper} sx={{ width: '95%' }} >
...
export const ColumnGroupingTable = () => {
    const columns = [
    ...
    return (
        <MyContainer title="Column Grouping Table">
            <Paper sx={{ width: '95%' }}>
...
export const EnhancedTable = () => {
    ...
    const rows = [
        ...
        createData(12, 'Nouget', 360, 19.0, 9, 37.0),
    ...
    return (
        <MyContainer title="Enhanced Table">
                ...
                <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right">Calories</TableCell>
                            <TableCell align="right">Fat&nbsp;(g)</TableCell>
                            <TableCell align="right">Cardbs&nbsp;(g)</TableCell>
                            <TableCell align="right">Protein&nbsp;(g)</TableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
...
export const DataTable = () => {
    ...
    const rows = [
        ...
        { id: 8, lastName: 'Frances', firstName: 'Rossino', age: 36 },
        { id: 9, lastName: 'Roxie', firstName: 'Hervey', age: 65 },
    ];

    const paginationModel = { page: 0, pageSize: 5 };

    return (
        <MyContainer title="Data Table">
            <Paper sx={{ height: 'auto', width: '95%' }}>
                <DataGrid
                    rows={rows}
                    columns={columns}
