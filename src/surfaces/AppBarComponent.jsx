...
export const PrimarySearchAppBar = () => {
        ...
        >
            ...
            <MenuItem onClick={handleProfileMenuOpen}>
                <IconButton
                    ...
                    aria-controls="primary-search-accont-menu"
                    aria-haspopup="true"
                    color="inherit"
                >
                    <AccountCircle />
    ...
    return (
        <MyContainer title="Primary Search AppBar">
            <Box sx={{ width: '95%' }}>
                <AppBar position="static">
                    <Toolbar>
                        <IconButton
...
export const SearchAppBar = () => {
    ...
    return (
        <MyContainer title="Search AppBar">
            <Box sx={{ width: '95%' }}>
                <AppBar position='static'>
                    <Toolbar>
                        <IconButton
...
export const ResponsiveAppBar = () => {
    ...
    return (
        <MyContainer title="Responsive AppBar">
            <Box sx={{ width: '95%' }}>
                <AppBar position="static">
...
export const MenuAppBar = () => {
    ...
    return (
        <MyContainer title="Menu App Bar">
            <Box sx={{ width: '95%' }}>
                <FormGroup>
                    <FormControlLabel
                        control={
...
export const ButtonAppBar = () => {
    return (
        <MyContainer title="Button AppBar">
            <Box sx={{ width: '95%' }}>
                <AppBar position="static">
                    <Toolbar>
                        <IconButton
